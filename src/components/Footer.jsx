        ...
        <div className="container p-4">
          <section className="mb-1">
            <svg
              ...
              height="1.5rem"
              fill="currentColor"
              className="bi bi-facebook mr-3 someIcon pointer"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="1.5rem"
              fill="currentColor"
              className="bi bi-instagram mr-3 someIcon pointer"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="1.5rem"
              fill="currentColor"
              className="bi bi-twitter mr-3 someIcon pointer"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="1.5rem"
              fill="currentColor"
              className="bi bi-youtube mr-3 someIcon pointer"
              viewBox="0 0 16 16"
            >
